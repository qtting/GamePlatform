...
func GetBoolWithDefault(name string, defaultValue interface{}) bool {
	viper.SetDefault(name, defaultValue)
	return viper.GetBool(name)
}

func GetStringMapStringWithDefault(name string, defaultValue interface{}) map[string]string {
	viper.SetDefault(name, defaultValue)
	return viper.GetStringMapString(name)
}

func GetStringSliceWithDefault(name string, defaultValue interface{}) []string {
	viper.SetDefault(name, defaultValue)
	return viper.GetStringSlice(name)
}

func GetIntSliceWithDefault(name string, defaultValue interface{}) []int {
	viper.SetDefault(name, defaultValue)
	arr := viper.GetStringSlice(name)
	ret := make([]int, len(arr), len(arr))
	var err error
